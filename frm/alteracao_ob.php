...
$sql_query = mysqli_query($link,"SELECT * FROM ob WHERE cod = '".$cod."'");
...
<div class="page-header">
        <h1>Alteração de Obrigações</h1>
</div>

<form name="cadastro" id="cadastro" method="POST" action="../op/alterar_ob.php?cod=<?php echo $cod?>" >
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="txtTitulo" name="txtTitulo" type="text" value="<?php echo $linha["titulo"] ?>" placeholder="Digite o título" class="form-control input-md" required="">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
     <select name="txtTipo" id="txtTipo" class="form-control">
        ...
        <option value="D" <?php if ($linha["tipo"]=='D') echo 'selected="selected"'?>> Documento</option>
        <option value="G" <?php if ($linha["tipo"]=='G') echo 'selected="selected"'?>> Guia</option>
    </select>
  </div>
</div>
<?php } ?>
