  ...
  <label class="col-md-4 control-label" for="txtDescricao"></label>  
     <table id="mt" cellpadding="0" cellspacing="0" border="0" class="table">
      ...
      <tr>
        ...
        <td><a href='/prot/frm/devolucao_proc.php?cod=<?php echo $cod ?>'><span style="color: #088A08;font-size: 28px;" class="glyphicon glyphicon-ok" alt='Receber' title='Devolver este processo'></span></a></td>
      </tr>
      <?php } ?>
    </table>
