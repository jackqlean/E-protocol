...
$ARRAY_PROCESSO_ENV = [];	
$ARRAY_PROCESSO_ENV = consultaDetalhes_Proc_Env($link);
$pcod 		= $ARRAY_PROCESSO_ENV[0];
$nome_req 		= $ARRAY_PROCESSO_ENV[1];
$ptipo 	= $ARRAY_PROCESSO_ENV[7];
$assunto 		= $ARRAY_PROCESSO_ENV[2];
$descricao		= $ARRAY_PROCESSO_ENV[8];
$usuario_env 	= $ARRAY_PROCESSO_ENV[3];
...
$ARRAY_PROCESSO_REC = [];	
$ARRAY_PROCESSO_REC = consultaDetalhes_Proc_Rec($link);
$usuario_rec 	= $ARRAY_PROCESSO_REC[0];
$setor_dst 	= $ARRAY_PROCESSO_REC[1];
$data_rec 	= $ARRAY_PROCESSO_REC[2];
$horas_rec 	= $ARRAY_PROCESSO_REC[3];
...
$pdf->Cell(0,52,'Registro de Protocolo',0,1,'C');
$pdf->SetFont('Arial', 'B', 12);
$pdf->Rect(10,160,575,160);
$pdf->Ln(2);
$pdf->Cell(100,60,'Protocolo nº:',0,0,'L');
